...
use crate::util::socket_descriptor::SocketDescriptor;
...
#[no_mangle]
pub extern "C" fn node_create(node_secret_key: *const u8, ephemeral_private_key: *const u8, current_blockchain_height: usize, network_callback: fn(BufferResponse) -> BufferArgument) -> *mut Node {

	// call network argument
	let callback_argument: BufferResponse = vec![5, 4, 3, 2, 1].into();
	let callback_response = network_callback(callback_argument);
