...
int main() {
	...
	/*LDKKeysManager keys =*/ KeysManager_new(&node_seed, net, logger, 0, 0);
	LDKKeysInterface keys_source; // TODO: Get this from KeysManager_new

	LDKUserConfig config; //TODO: expose Default::default()
