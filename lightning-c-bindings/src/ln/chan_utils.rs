...
/// " The hash of the preimage which unlocks this HTLC."
#[no_mangle]
pub extern "C" fn HTLCOutputInCommitment_set_payment_hash(this_ptr: &mut HTLCOutputInCommitment, val: [u8; 32]) {
...
pub extern "C" fn LocalCommitmentTransaction_free(this_ptr: LocalCommitmentTransaction) {
	let _ = unsafe { Box::from_raw(this_ptr.inner as *mut lnLocalCommitmentTransaction) };
}
...
/// " The commitment transaction itself, in unsigned form."
#[no_mangle]
pub extern "C" fn LocalCommitmentTransaction_set_unsigned_tx(this_ptr: &mut LocalCommitmentTransaction, val: crate::c_types::Transaction) {
...
/// " Our counterparty's signature for the transaction, above."
#[no_mangle]
pub extern "C" fn LocalCommitmentTransaction_set_their_sig(this_ptr: &mut LocalCommitmentTransaction, val: crate::c_types::Signature) {
...
/// " The key derivation parameters for this commitment transaction"
#[no_mangle]
pub extern "C" fn LocalCommitmentTransaction_set_local_keys(this_ptr: &mut LocalCommitmentTransaction, val: TxCreationKeys) {
	unsafe { &mut *(this_ptr.inner as *mut lnLocalCommitmentTransaction) }.local_keys = *unsafe { Box::from_raw(val.inner as *mut _) };
}
/// " The feerate paid per 1000-weight-unit in this commitment transaction. This value is"
/// " controlled by the channel initiator."
#[no_mangle]
pub extern "C" fn LocalCommitmentTransaction_set_feerate_per_kw(this_ptr: &mut LocalCommitmentTransaction, val: u64) {
...
#[no_mangle]
pub extern "C" fn LocalCommitmentTransaction_get_local_sig(this_arg: &LocalCommitmentTransaction, funding_key: *const [u8; 32], funding_redeemscript: crate::c_types::Script, channel_value_satoshis: u64) -> crate::c_types::Signature {
