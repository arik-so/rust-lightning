...
type lnPeerManager = lnPeerManagerImport<crate::ln::peer_handler::SocketDescriptor, crate::ln::msgs::ChannelMessageHandler, crate::ln::msgs::RoutingMessageHandler>;
...
pub extern "C" fn PeerManager_new(message_handler: MessageHandler, our_node_secret: crate::c_types::SecretKey, ephemeral_random_data: *const [u8; 32], logger: crate::util::logger::Logger) -> PeerManager {
	...
	let ret = lightning::ln::peer_handler::PeerManager::new(*unsafe { Box::from_raw(message_handler.inner as *mut _) }, our_node_secret.into_rust(), unsafe { &*ephemeral_random_data}, rust_logger);
