...
impl ChannelMonitorUpdateErr {
	...
	#[allow(unused)]
	pub(crate) fn into_ln(self) -> lnChannelMonitorUpdateErr {
		match self {
			ChannelMonitorUpdateErr::TemporaryFailure => lnChannelMonitorUpdateErr::TemporaryFailure,
			ChannelMonitorUpdateErr::PermanentFailure => lnChannelMonitorUpdateErr::PermanentFailure,
		}
	...
	#[allow(unused)]
	pub(crate) fn ln_into(lnt: lnChannelMonitorUpdateErr) -> Self {
		match lnt {
			lnChannelMonitorUpdateErr::TemporaryFailure => ChannelMonitorUpdateErr::TemporaryFailure,
			lnChannelMonitorUpdateErr::PermanentFailure => ChannelMonitorUpdateErr::PermanentFailure,
		}
...
impl lnManyChannelMonitor for ManyChannelMonitor {
	...
	fn add_monitor(&self, funding_txo: lightning::chain::transaction::OutPoint, monitor: lightning::ln::channelmonitor::ChannelMonitor<Self::Keys>) -> Result<(), lightning::ln::channelmonitor::ChannelMonitorUpdateErr> {
		...
		let mut local_ret = match ret.result_good { true => Ok( { () /*(*unsafe { Box::from_raw(ret.contents.result.take_ptr()) })*/ }), false => Err( { (*unsafe { Box::from_raw(ret.contents.err.take_ptr()) }).into_ln() })};
		local_ret
	}
...
pub extern "C" fn ChannelMonitor_update_monitor(this_arg: &mut ChannelMonitor, mut updates: crate::ln::channelmonitor::ChannelMonitorUpdate, broadcaster: &crate::chain::chaininterface::BroadcasterInterface, logger: &crate::util::logger::Logger) -> crate::c_types::derived::CResult_NoneMonitorUpdateErrorZ {
	let mut ret = unsafe { &mut (*(this_arg.inner as *mut lnChannelMonitor)) }.update_monitor(*unsafe { Box::from_raw(updates.inner.take_ptr() as *mut _) }, broadcaster, logger);
	let mut local_ret = match ret{ Ok(mut o) => crate::c_types::CResultTempl::good( { 0u8 /*o*/ }), Err(mut e) => crate::c_types::CResultTempl::err( { crate::ln::channelmonitor::MonitorUpdateError { inner: Box::into_raw(Box::new(e)), _underlying_ref: false } }) };
	local_ret
}
...
pub extern "C" fn ChannelMonitor_get_and_clear_pending_events(this_arg: &mut ChannelMonitor) -> crate::c_types::derived::CVec_EventZ {
	let mut ret = unsafe { &mut (*(this_arg.inner as *mut lnChannelMonitor)) }.get_and_clear_pending_events();
...
pub extern "C" fn ChannelMonitor_get_latest_local_commitment_txn(this_arg: &mut ChannelMonitor, logger: &crate::util::logger::Logger) -> crate::c_types::derived::CVec_TransactionZ {
	let mut ret = unsafe { &mut (*(this_arg.inner as *mut lnChannelMonitor)) }.get_latest_local_commitment_txn(logger);
	let mut local_ret = Vec::new(); for item in ret.drain(..) { local_ret.push( { let local_ret_0 = ::bitcoin::consensus::encode::serialize(&item); local_ret_0.into() }); };
	local_ret.into()
}
